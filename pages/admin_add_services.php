                ...
                <div class="x_panel" style="display:block;margin:auto;margin-top:100px;margin-bottom:100px;">
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            <form action="../php/add_services.php" method="POST" class="form-horizontal form-label-left" novalidate enctype="multipart/form-data">
                                ...
                                <div class="item form-group">
                                    ...
                                    <center>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            ...
                                            <input type="file" name="logo" id="profile-img" accept="image/*" capture="camera" required>
                                        </div>
                                    </center>
                                </div>
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input class="form-control col-md-7 col-xs-12" data-validate-length-range="3" name="title" placeholder="Enter title" required="required" type="text">
                                    </div>
                                </div>
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input class="form-control col-md-7 col-xs-12" name="sub_title" placeholder="Enter subtitle title" type="text">
                                    </div>
                                </div>
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input class="form-control col-md-7 col-xs-12" data-validate-length-range="3" name="price" placeholder="Enter Price" required="required" type="text">
                                    </div>
                                </div>
                                <div class="ln_solid"></div>
                                <div class="form-group">
                                    <div class="col-md-6 col-md-offset-3">
                                        <button id="send" type="submit" class="btn btn-primary">Add Services</button>
                                    </div>
                                </div>
                            </form>
                        </div>
