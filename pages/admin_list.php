                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="x_panel" style="overflow:hidden">
                            <span class="section">Admin List</span>
                            <div class="x_content">
                                ...
                                <table id="datatable-buttons" class="table table-striped table-bordered" style="width:100%;">
                                    ...
                                    <tbody>
                                        ...
                                        while ($row = mysqli_fetch_object($sql)) :
                                            $user_id = $row->id;
                                            $full_name = "{$row->fname} {$row->mname[0]}. {$row->lname}";
                                            ?>

                                            <tr>
                                                <td><?php print_r("{$row->fname} {$row->mname} {$row->lname}") ?></td>
                                                <td><?php echo $row->email ?></td>
                                                <td><?php echo $row->contact_number ?></td>
                                                <td><?php echo $row->uname ?></td>
                                                <td><?php echo $row->createAt ?></td>
                                                <td style="text-align:center;">
                                                    <a href="admin_edit_page.php?id=<?php echo $user_id ?>" class="btn btn-info btn-xs">
                                                        <i class="fa fa-pencil"></i> Edit
                                                    </a>
                                                    <a onclick="return confirm('Are you sure you want to remove <?php echo $full_name ?>')" href="../php/delete_admin.php?id=<?php echo $user_id ?>" class="btn btn-danger btn-xs">
